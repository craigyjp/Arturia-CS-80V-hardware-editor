...
//          renderEnv(filterAttack * 0.0001, filterDecay * 0.0001, filterSustain, filterRelease * 0.0001);
          break;
        case AMP_ENV1:
          renderEnv(ampAttack1 * 0.0001, ampDecay1 * 0.0001, ampSustain1, ampRelease1 * 0.0001);
          break;
        case AMP_ENV2:
          renderEnv(ampAttack2 * 0.0001, ampDecay2 * 0.0001, ampSustain2, ampRelease2 * 0.0001);
          break;
      }
      break;
  }
